 ...
 */
export class CommandsStructure {
 ...
 */
export class StartOptionStructure {
 ...
 */
export class NodeStateGlobals {
  /**
   * Write node state globals to memory
   */
  static writeToMemory(emulator: MoiraEmulator, baseAddr: number, session: any): void {
 ...
 */
export class SharedBBSData {
  private cmdsAddr: number = 0;
  private soptAddr: number = 0;
  private nodeStateAddr: number = 0;

  constructor(
    private emulator: MoiraEmulator,
    private baseAddr: number = 0xF00300 // Start after user structures
  ) {
