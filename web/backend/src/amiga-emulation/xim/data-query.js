...
class XIMDataQueryHandler {
    ...
    handleDataQuery(msg) {
        ...
        const user = (_a = this.bbsSession) === null || _a === void 0 ? void 0 : _a.user;
        switch (msg.command) {
            case types_1.XIMCommand.DT_NAME:
                if (isRead) {
                    const username = (user === null || user === void 0 ? void 0 : user.username) || 'Guest';
            ...
            case types_1.XIMCommand.DT_LOCATION:
                if (isRead) {
                    const location = (user === null || user === void 0 ? void 0 : user.location) || 'Unknown';
            ...
            case types_1.XIMCommand.DT_REALNAME:
                if (isRead) {
                    const realname = (user === null || user === void 0 ? void 0 : user.realname) || '';
            ...
            case types_1.XIMCommand.DT_SLOTNUMBER:
                if (isRead) {
                    const slotNum = (user === null || user === void 0 ? void 0 : user.id) || 1;
            ...
            case types_1.XIMCommand.DT_SECSTATUS:
                if (isRead) {
                    const secLevel = (user === null || user === void 0 ? void 0 : user.secLevel) || 10;
            ...
            case types_1.XIMCommand.DT_SECBOARD:
                if (isRead) {
                    const secBoard = (user === null || user === void 0 ? void 0 : user.secBoard) || 0;
            ...
            case types_1.XIMCommand.DT_SECLIBRARY:
                if (isRead) {
                    const secLibrary = (user === null || user === void 0 ? void 0 : user.secLibrary) || 0;
            ...
            case types_1.XIMCommand.DT_SECBULLETIN:
                if (isRead) {
                    const secBulletin = (user === null || user === void 0 ? void 0 : user.secBulletin) || 0;
            ...
            case types_1.XIMCommand.DT_TIMELIMIT:
                if (isRead) {
                    const timeLimit = (user === null || user === void 0 ? void 0 : user.timeLimit) || 60;
            ...
            case types_1.XIMCommand.DT_MESSAGESPOSTED:
                if (isRead) {
                    const msgs = (user === null || user === void 0 ? void 0 : user.messagesPosted) || 0;
            ...
            case types_1.XIMCommand.DT_UPLOADS:
                if (isRead) {
                    const uploads = (user === null || user === void 0 ? void 0 : user.uploads) || 0;
            ...
            case types_1.XIMCommand.DT_DOWNLOADS:
                if (isRead) {
                    const downloads = (user === null || user === void 0 ? void 0 : user.downloads) || 0;
            ...
            case types_1.XIMCommand.DT_TIMESCALLED:
                if (isRead) {
                    const calls = (user === null || user === void 0 ? void 0 : user.timesCalled) || 0;
            ...
            case types_1.XIMCommand.DT_TIMELASTON:
                if (isRead) {
                    const lastOn = (user === null || user === void 0 ? void 0 : user.lastLoginAt) ? Math.floor(new Date(user.lastLoginAt).getTime() / 1000) : 0;
            ...
            case types_1.XIMCommand.DT_TIMEUSED:
                if (isRead) {
                    const timeUsed = (user === null || user === void 0 ? void 0 : user.timeUsed) || 0;
            ...
            case types_1.XIMCommand.DT_TIMETOTAL:
                if (isRead) {
                    const timeTotal = (user === null || user === void 0 ? void 0 : user.timeTotal) || 0;
            ...
            case types_1.XIMCommand.DT_BYTESUPLOAD:
                if (isRead) {
                    const bytesUp = (user === null || user === void 0 ? void 0 : user.bytesUpload) || 0;
            ...
            case types_1.XIMCommand.DT_BYTEDOWNLOAD:
                if (isRead) {
                    const bytesDown = (user === null || user === void 0 ? void 0 : user.bytesDownload) || 0;
            ...
            case types_1.XIMCommand.DT_DAILYBYTELIMIT:
                if (isRead) {
                    const limit = (user === null || user === void 0 ? void 0 : user.dailyBytesLimit) || 0;
            ...
            case types_1.XIMCommand.DT_DAILYBYTEDLD:
                if (isRead) {
                    const dailyDld = (user === null || user === void 0 ? void 0 : user.dailyBytesDld) || 0;
            ...
            case types_1.XIMCommand.DT_HOSTNAME:
                if (isRead) {
                    const hostname = ((_b = this.bbsSession) === null || _b === void 0 ? void 0 : _b.hostname) || 'localhost';
            ...
            case types_1.XIMCommand.DT_HOSTIP:
                if (isRead) {
                    const hostip = ((_c = this.bbsSession) === null || _c === void 0 ? void 0 : _c.hostip) || '127.0.0.1';
            ...
            case types_1.XIMCommand.DT_STAMP_LASTON:
                if (isRead) {
                    ...
                    if (user === null || user === void 0 ? void 0 : user.lastLoginAt) {
            ...
            case types_1.XIMCommand.DT_CONFACCESS:
                if (isRead) {
                    const confAccess = (user === null || user === void 0 ? void 0 : user.confAccess) || '';
            ...
            case types_1.XIMCommand.DT_LANGUAGE:
                if (isRead) {
                    const language = (user === null || user === void 0 ? void 0 : user.language) || 'txt';
            ...
            case types_1.XIMCommand.DT_ISANSI:
                if (isRead) {
                    const isAnsi = (user === null || user === void 0 ? void 0 : user.ansi) || true;
