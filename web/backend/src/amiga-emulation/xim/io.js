...
exports.XIMIOHandler = void 0;
class XIMIOHandler {
    constructor(emulator, execLibrary, socket, messageParser) {
        this.inputQueue = [];
        this.keyState = {}; // Simultaneous key state tracking
        // Line input state
    ...
    handleUserData(msg, bbsSession) {
        ...
        switch (msg.data) {
            case 1: // Security level (divided by 10)
                resultData = Math.floor((((_a = bbsSession.user) === null || _a === void 0 ? void 0 : _a.secLevel) || 0) / 10);
                break;
            case 2: // Expert mode flag ('X' = expert)
                resultData = (((_b = bbsSession.user) === null || _b === void 0 ? void 0 : _b.expert) === 'X') ? 1 : 0;
                break;
            case 3: // Reserved
                resultData = 0;
                break;
            ...
            case 5: // Times called (duplicate in original)
                resultData = ((_c = bbsSession.user) === null || _c === void 0 ? void 0 : _c.timesCalled) || 0;
                break;
            ...
            case 9: // User line length
                resultData = ((_d = bbsSession.user) === null || _d === void 0 ? void 0 : _d.lineLen) || 80;
                break;
            default:
                resultData = 0;
        }
     ...
     */
    handleUserString(msg, bbsSession) {
        var _a, _b, _c, _d, _e;
        const stringAddr = this.emulator.readMemory32(msg.msgAddr + 26);
        let resultString = '';
        ...
        switch (msg.data) {
            case 1: // Username (max 21 chars)
                resultString = (((_a = bbsSession.user) === null || _a === void 0 ? void 0 : _a.name) || '').substring(0, 21);
                break;
            case 2: // Empty string
                resultString = '';
                break;
            case 3: // Location (max 39 chars)
                resultString = (((_b = bbsSession.user) === null || _b === void 0 ? void 0 : _b.location) || '').substring(0, 39);
                break;
            case 4: // Location (max 29 chars)
                resultString = (((_c = bbsSession.user) === null || _c === void 0 ? void 0 : _c.location) || '').substring(0, 29);
                break;
            case 5: // State code (max 2 chars)
                resultString = (((_d = bbsSession.user) === null || _d === void 0 ? void 0 : _d.location) || '').substring(0, 2);
                break;
            case 6: // Zip code (max 7 chars)
                resultString = (((_e = bbsSession.user) === null || _e === void 0 ? void 0 : _e.location) || '').substring(0, 7);
                break;
            case 7: // Door path
...
exports.XIMIOHandler = XIMIOHandler;
