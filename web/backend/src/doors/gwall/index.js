...
function resolveGlobalWallDir() {
    return (0, door_path_util_1.resolveDoorResourcePath)('doors', 'gwall') || path_1.default.join(PROJECT_ROOT, 'doors', 'gwall');
}
function resolveGlobalWallFile(filename) {
    return (0, door_path_util_1.resolveDoorResourcePath)('doors', 'gwall', filename) || path_1.default.join(resolveGlobalWallDir(), filename);
}
// Constants
const BUFSIZE = 8192;
const MAXSTYLE = 4;
