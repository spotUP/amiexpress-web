 ...
 *
 * IMPORTANT: these constants are duplicated verbatim in
 * `packages/terminal/src/petscii/c64-palette.ts` because the frontend
 * package cannot import from the backend. Keep both copies in sync - if you
