...
## Summary
- The TypeScript 2048 SDK example (`sdk/examples/2048-game`) failed under the new TypeScript door loader because it did not provide the required `runDoor()` export. The BBS runtime therefore aborted execution with "No runDoor() export found".
...
### Files
1. `sdk/examples/2048-game/index.ts`
