...
.dos_jump_table_loop	subq.l	#6,a0
	...
	move.l	a0,AllocVec+2(a6)
	lea	myfreemem(pc),a0
	move.l	a0,FreeMem+2(a6)
	move.l	a0,FreeVec+2(a6)
...
* this function calls startint function (existence must be checked before)
...
exec_cause
	...
	beq.b	not_soft_irq
	move.l	IS_DATA(a1),a3			; Interrupt data
...
int_level_ok
	...
	move.l	(a4,d0),-(a7)	* get old IS_DATA
