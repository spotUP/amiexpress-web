...
- New: Door Doctor now includes PY/AREXX checks (entry extensions, optional py_compile via DOCTOR_COMPILE_PY=1, optional runtime smoke via DOCTOR_RUN=1; warns if AREXX lacks a run script).
