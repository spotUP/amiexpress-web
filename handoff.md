...
- Next: Wire `npm run door:ci` into CI (AREXX run skips if interpreter missing), mock BBS IO in harness, and polish the log panel (scrolling) plus search/filter hints. Tests not rerun beyond `door:ci`.
