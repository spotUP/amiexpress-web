...
- Next: Door CI installs regina-rexx and runs `door:ci`; remaining niceties: richer log scrolling/search hints in Door Manager and optional AREXX interpreter locally. Tests not rerun beyond `door:ci`.
