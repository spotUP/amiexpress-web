...
export async function showHelpScreen(ctx: DisplayContext): Promise<void> {
  ...
  const helpText = [
    ...
    '',
    c(2, ' === FUNCTION KEYS ==='),
    '   ' + c(3, 'F1') + ' - Show this help screen',
    '   ' + c(3, 'F2') + ' - Save file (quick save current file)',
    '   ' + c(3, 'F3') + ' - Load file (open file browser)',
    '   ' + c(3, 'F4') + ' - New canvas (clear and start fresh)',
    '   ' + c(3, 'F5') + ' - Tool selector (show all tools)',
    '   ' + c(3, 'F6') + ' - Foreground color picker (interactive)',
    '   ' + c(3, 'F7') + ' - Background color picker (interactive)',
    '   ' + c(3, 'F8') + ' - Cycle foreground color up',
    '   ' + c(3, 'F9') + ' - Cycle background color up',
    '   ' + c(3, 'F10') + ' - Recent files (sysop/cosysop only)',
    '   ' + c(3, 'Shift+F10') + ' - Gallery browser (sysop/cosysop only)',
    '',
    c(2, ' === CURSOR MOVEMENT ==='),
    ...
    '   Enter - Move to next line (insert mode); confirm tool operations',
    '   Escape - Exit editor, cancel selection, or close modals',
    '',
    c(2, ' === DRAWING TOOLS ==='),
    '   Tab / F5 - Show tool selector modal (choose from all tools)',
