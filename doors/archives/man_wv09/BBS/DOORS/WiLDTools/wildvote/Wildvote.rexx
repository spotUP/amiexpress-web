...
headb = "[A[31;47;4m  WiLDVoTe v0.9                    AmiExpress Door written '94 by WiLD THiNG  [0m[B"
...
getuser 127; locat=RESULT; filename = locat"upload/WVRES.TXT"
x = 1; resbar = "[47m "
DO UNTIL X = tems
 resbar = resbar" "
  x = x + 1
...
END; CLOSE(resu);END
tr ""
tr "[A[32mYou can download now the result file under the name [33mWVRES.TXT[32m"
tr "in  the current conference"
...
votefn = path"answers/"username;
   tr "[B[32mWiLDVote v0.9 [33m[--> [36m Mannassas [35m /X [36m DeZiGN [33m <--][0m"
...
ck = 0
   ...
   END
   tr ""
   sendmessage "[35mDo you want to vote now ? "; GETCHAR; wannavote = RESULT;
   tr wannavote"2B"
   if wannavote ~= "y" then DO; SHUTDOWN; EXIT; END
 END
