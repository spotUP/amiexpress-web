 ...
 * ```
 */
export function padEndVisible(str: string, targetWidth: number, fillChar: string = ' '): string {
 ...
 * ```
 */
export function padStartVisible(str: string, targetWidth: number, fillChar: string = ' '): string {
  const currentVisibleWidth = visibleLength(str);
  const paddingNeeded = Math.max(0, targetWidth - currentVisibleWidth);
 ...
 * ```
 */
export function centerVisible(str: string, targetWidth: number, fillChar: string = ' '): string {
  const currentVisibleWidth = visibleLength(str);
 ...
 * ```
 */
export function getCenterX(str: string, screenWidth: number = 80): number {
 ...
 * ```
 */
export function truncateVisible(str: string, maxWidth: number, ellipsis: string = '...'): string {
 ...
 * ```
 */
export function substringVisible(str: string, start: number, end?: number): string {
  let result = '';
  let visibleCount = 0;
  let i = 0;
 ...
 * ```
 */
export function measureWidth(lines: string[]): number {
