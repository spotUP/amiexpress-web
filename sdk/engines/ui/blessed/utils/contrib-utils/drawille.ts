...
export class DrawilleCanvas {
  ...
  set(x: number, y: number): void {
    ...
    this.colors[coord] = typeof this.color === 'string' ? colors[this.color as keyof typeof colors] : this.color;
  ...
  writeText(str: string, x: number, y: number): void {
    ...
    const bg = typeof this.fontBg === 'string' ? colors[this.fontBg as keyof typeof colors] : this.fontBg;
    const fg = typeof this.fontFg === 'string' ? colors[this.fontFg as keyof typeof colors] : this.fontFg;
