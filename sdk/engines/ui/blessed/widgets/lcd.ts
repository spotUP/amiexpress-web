...
export class LCD extends Canvas {
  ...
  constructor(options: LCDOptions = {}) {
    ...
    const applyData = () => {
      if (!this.segment16 && (this as any).ctx) {
  ...
  private _renderDisplay(display: number | string): void {
    ...
    (this as any).ctx.clearRect(0, 0, (this as any).canvasSize!.width, (this as any).canvasSize!.height);
...
class SixteenSegment {
  ...
  CalcElementDimensions(): { Width: number; Height: number } {
 ...
 * Factory function
 */
export function lcd(options: LCDOptions = {}): LCD {
