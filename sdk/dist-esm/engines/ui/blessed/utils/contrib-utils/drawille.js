...
export class DrawilleCanvas {
    ...
    set(x, y) {
        ...
        this.colors[coord] = typeof this.color === 'string' ? colors[this.color] : this.color;
    ...
    writeText(str, x, y) {
        ...
        const bg = typeof this.fontBg === 'string' ? colors[this.fontBg] : this.fontBg;
        const fg = typeof this.fontFg === 'string' ? colors[this.fontFg] : this.fontFg;
