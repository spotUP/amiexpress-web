...
import { stripAnsi } from '../../core/ansi-string-utils';
export class GraphicsEngine {
     ...
     * ```
     */
    drawChar(x, y, char, fg = AnsiColor.White, bg = AnsiColor.Black) {
     ...
     * ```
     */
    drawText(x, y, text, fg = AnsiColor.White, bg = AnsiColor.Black) {
     ...
     * ```
     */
    drawRect(rect, char = '█', fg = AnsiColor.White, bg = AnsiColor.Black) {
     ...
     * ```
     */
    drawBox(rect, style = 'single', fg = AnsiColor.White) {
    ...
    renderCutsceneScene(scene, elapsed) {
        ...
        if (scene.text && scene.textPosition) {
            ...
            textLines.forEach((line, index) => {
                this.drawText(scene.textPosition.x, scene.textPosition.y + index, line, AnsiColor.White);
            });
        }
    }
    /**
