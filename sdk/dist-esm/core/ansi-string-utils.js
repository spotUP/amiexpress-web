 ...
 * ```
 */
export function padEndVisible(str, targetWidth, fillChar = ' ') {
 ...
 * ```
 */
export function padStartVisible(str, targetWidth, fillChar = ' ') {
    const currentVisibleWidth = visibleLength(str);
    const paddingNeeded = Math.max(0, targetWidth - currentVisibleWidth);
 ...
 * ```
 */
export function getCenterX(str, screenWidth = 80) {
 ...
 * ```
 */
export function truncateVisible(str, maxWidth, ellipsis = '...') {
 ...
 * ```
 */
export function substringVisible(str, start, end) {
    let result = '';
    let visibleCount = 0;
    let i = 0;
 ...
 * ```
 */
export function measureWidth(lines) {
 ...
 * ```
 */
export function formatInBox(text, width, align = 'left') {
