/*
** $VER: ImageBackFill.c 1.231 (19.3.95)
**
...
static void __saveds __asm WindowPatternBackFillFunc(register __a0 struct Hook *Hook,register __a2 struct RastPort *RP,register __a1 struct BackFillMsg *BFM)
{
...
{
	if (DataTypesBase) // safety check, if not used with V39++
	{
