;/*
sc SpeedBar.c LINK LIB lib:reaction.lib NOSTACKCHECK
quit
*/
...
{GID_SPEEDBAR,  1, NULL, 0},
{GID_SPEEDBAR,  2, NULL, 0},
{GID_SPEEDBAR,  3, NULL, 0},
{GID_SPEEDBAR,  4, NULL, 0},
{GID_SPEEDBAR,  5, NULL, 0},
{GID_SPEEDBAR,  6, NULL, 0},
{GID_SPEEDBAR,  7, NULL, 0},
{GID_SPEEDBAR,  8, NULL, 0},
{GID_SPEEDBAR,  9, NULL, 0},
{GID_SPEEDBAR, 10, NULL, 0},
...
int main(void)
{
	...
	for (i = 0; i < 10; i++)
	{
		hintinfo[i].hi_Text = help_strs[i];
	}
		...
		if ( AppPort = CreateMsgPort() )
		{
			...
			if (objects[OID_MAIN])
			{
				...
				if (windows[WID_MAIN] = (struct Window *) RA_OpenWindow(objects[OID_MAIN]))
				{
					...
					SetGadgetAttrs(gadgets[GID_SPEEDBAR], windows[WID_MAIN], NULL, SPEEDBAR_Window, windows[WID_MAIN], TAG_DONE);
