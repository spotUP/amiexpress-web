...
#if defined(AMIGA)
const char version_tag[] = "$VER: wget 1.7 (21.11.2019) Based upon GNU wget 1.10.1\r\n";
...
/* This is for clib2, for setting the minimum stack size for this
   ...
   too little, and some 6000 bytes seem to be the minimum which
   works. We try to play it safe here. */
char * __stack_size_string = "$STACK: 10000";
unsigned int __stack_size = 10000;
#endif /* AMIGA */
