...
export const PAGES: PageMeta[] = [
  ...
  },
  {
    ...
    label: 'Lookup Tables',
    category: 'System',
    footerHint: '[1-5] switch tab  [n]ew  [e]dit  [d]el  [E]rrors (checkers)  [↑↓] scroll',
    helpKeys: [
      ...
      ['E',  'File checkers tab only: manage the selected checker\'s error patterns ([esc] back)'],
    ],
    implemented: true,
  },
  {
  ...
  },
  {
    ...
    label: 'Audit Log',
    category: 'Diagnostics',
    footerHint: '[/]table  [#]record id  [c]lear  [r]efresh  [↑↓] scroll',
    helpKeys: [
      ['↑↓', 'Select an entry — its before/after diff shows below'],
      ['/',  'Filter by table name'],
      ['#',  'Filter by record id'],
      ['c',  'Clear both filters'],
      ['r',  'Refresh from server (keeps active filters)'],
    ],
    implemented: true,
  },
  {
