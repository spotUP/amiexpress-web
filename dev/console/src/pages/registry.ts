...
export const PAGES: PageMeta[] = [
  ...
  // ─── Files ─────────────────────────────────────────────────────
  { id: 'drives',         label: 'Drives',          category: 'Files', footerHint: '(coming in phase C)', helpKeys: [], implemented: false },
  { id: 'file-checkers',  label: 'File Checkers',   category: 'Files', footerHint: '(coming in phase C)', helpKeys: [], implemented: false },
  ...
  { id: 'languages',    label: 'Languages',    category: 'System', footerHint: '(coming in phase C)', helpKeys: [], implemented: false },
  { id: 'protocols',    label: 'Protocols',    category: 'System', footerHint: '(coming in phase C)', helpKeys: [], implemented: false },
  { id: 'computers',    label: 'Computers',    category: 'System', footerHint: '(coming in phase C)', helpKeys: [], implemented: false },
  { id: 'screen-types', label: 'Screen Types', category: 'System', footerHint: '(coming in phase C)', helpKeys: [], implemented: false },
