...
/** In the round itself. */
export const IN_GAME_TRACK = 'cruel-king-of-vendelos.xm';

/** Menus, high scores, the attract loop, the level hand-over, game over. */
export const EVERYWHERE_ELSE_TRACK = 'greensleevesFIN2.xm';
 ...
 * restart the music.
 */
export function trackForState(state: GameState): string {
  switch (state) {
    case 'playing':
    case 'paused':
      return IN_GAME_TRACK;
    default:
      return EVERYWHERE_ELSE_TRACK;
  }
}
