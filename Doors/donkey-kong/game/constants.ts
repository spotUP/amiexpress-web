...
// Stage order
export const STAGE_ORDER: StageType[] = ['barrels', 'conveyors', 'elevators', 'rivets'];
...
// Conveyors Stage (50m)
const CONVEYORS_STAGE: StageData = {
  girders: [
    { x: 0, y: 20, width: 32, slope: 0 },
...
// Elevators Stage (75m)
const ELEVATORS_STAGE: StageData = {
  girders: [
...
export const STAGES: Record<StageType, StageData> = {
...
export function getStageData(level: number, stageIndex: number): { stage: StageType; data: StageData } {
