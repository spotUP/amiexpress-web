...
import { GAME_WIDTH, GAME_HEIGHT, GAME_TICK_MS, MENU_OPTIONS, STAGE_ORDER, } from "./game/constants";
export { rpcHandlers };
const door = new Door({
    name: "Donkey Kong",
    version: "1.0.0",
...
function startGame() {
    ...
    game = new DonkeyKongGame(gameData, (content) => {
        ...
        if (sfx && game)
            sfx.flush(game.cues);
    }, () => showGameOver(), () => showStageComplete());
    game.initStage();
    if (gameLoop)
...
function handleStageCompleteInput(key) {
