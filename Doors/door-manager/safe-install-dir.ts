...
export function isSafeToDelete(decision: InstallDirDecision): decision is ResolvedInstallDir {
  return (decision as ResolvedInstallDir).path !== undefined;
}
 ...
 */
export function resolveDoorInstallDir(
  projectRoot: string,
