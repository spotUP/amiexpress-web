...
function getCatalogSvc(): any {
  try { return require('../../web/backend/src/doors/door-catalog.service'); } catch { return null; }
}
function getStripLib(): any {
  try { return require('../../web/backend/src/doors/ami-stripper.lib'); } catch { return null; }
}
