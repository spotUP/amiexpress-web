...
exports.deleteIdentifierFor = deleteIdentifierFor;
 ...
 */
function deleteIdentifierFor(door) {
...
async function performDoorDelete(deps) {
    ...
    try {
        ...
        if (!result.success) {
            ...
            const view = (0, delete_outcome_1.deleteOutcomeView)({
                success: false,
                stillListed: true,
...
//# sourceMappingURL=delete-door-action.js.map