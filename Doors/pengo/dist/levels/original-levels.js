...
exports.ORIGINAL_LEVELS = exports.ORIGINAL_LEVEL_LEGEND = void 0;
exports.ORIGINAL_LEVEL_LEGEND = {
    empty: '.',
    ice: '#',
    diamond: 'D',
    egg: 'e',
};
exports.ORIGINAL_LEVELS = [
    // Level 1: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#...#.....#.',
        '.#.###.#e#.#.',
        '.#.....#...#.',
    ...
    // Level 2: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#...#.#.#...',
        '.#.#e#.#.#.#.',
        '.#.....#...#.',
    ...
    // Level 3: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#.#...#.....',
        '.#.#.#.#.#e#.',
        '.#...#...#.#.',
    ...
    // Level 4: 82 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#..#..#.#.#.',
        '.#..#.##.#.#.',
        '.#..#.#......',
    ...
    // Level 5: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '#.#...#...#..',
        '#.#.#.#.#.#..',
        '....#...#....',
    ...
    // Level 6: 74 blocks, 3 diamonds, 4 eggs (source counts)
    [
        '.............',
        '.###e#####e#.',
        '.#.#...#...#.',
    ...
    // Level 7: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#...#.....#.',
        '.#.###.#e#.#.',
        '.#.....#...#.',
    ...
    // Level 8: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#...#.#.#...',
        '.#.#e#.#.#.#.',
        '.#.....#...#.',
    ...
    // Level 9: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#.#...#.....',
        '.#.#.#.#.#e#.',
        '.#...#...#.#.',
    ...
    // Level 10: 82 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#..#..#.#.#.',
        '.#..#.##.#.#.',
        '.#..#.#......',
    ...
    // Level 11: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '#.#...#...#..',
        '#.#.#.#.#.#..',
        '....#...#....',
    ...
    // Level 12: 74 blocks, 3 diamonds, 4 eggs (source counts)
    [
        '.............',
        '.###e#####e#.',
        '.#.#...#...#.',
    ...
    // Level 13: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#.#...#.....',
        '.#.#.#.#.#e#.',
        '.#...#...#.#.',
    ...
    // Level 14: 82 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '.#..#..#.#.#.',
        '.#..#.##.#.#.',
        '.#..#.#......',
    ...
    // Level 15: 84 blocks, 3 diamonds, 6 eggs (source counts)
    [
        '#.#...#...#..',
        '#.#.#.#.#.#..',
        '....#...#....',
    ...
    // Level 16: 74 blocks, 3 diamonds, 4 eggs (source counts)
    [
        '.............',
        '.###e#####e#.',
        '.#.#...#...#.',
...
//# sourceMappingURL=original-levels.js.map