/**
 * Minimal test runner for the VOICE CHAT door.
 *
 ...
 * throwing. It runs under tsx rather than the backend's jest because this
 * door pulls the SDK's audio engine, which jest cannot parse from source.
 */

/* eslint-disable no-console */

const TEST_MODULES = ['./chrome-teardown.test'];
