...
async function createApp(session) {
    ...
    function updateLayout() {
        ...
        const solved = (0, layout_solver_1.solveLayout)({
            width,
            height,
            ...
            sidebarWidth: sidebarPanel.width,
            sidebarDock: sidebarPanel.getDockPosition(),
        }, {
            menuHeight: menu_bar_1.MENU_HEIGHT,
            statusHeight: status_bar_1.STATUS_HEIGHT,
            inputHeight: input_box_1.INPUT_HEIGHT,
            emojiButtonWidth: input_box_1.EMOJI_BUTTON_WIDTH,
        });
    ...
    const voiceUserId = session.user?.id ?? userId;
    ...
    socket.on('audio:devices', (data) => {
        cmdCtx.micDevices = data?.devices ?? [];
    });
