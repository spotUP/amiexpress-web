...
exports.HELP_PART_1 = `{bold}{${door_theme_1.T.accent}-fg}=== LIVECHAT v3.0 - DESKTOP-LEVEL BBS CHAT ==={/${door_theme_1.T.accent}-fg}{/bold}

{${door_theme_1.T.accentAlt}-fg}A full-featured multi-user chat system with neo-blessed UI{/${door_theme_1.T.accentAlt}-fg}

{bold}{${door_theme_1.T.ok}-fg}--- KEYBOARD SHORTCUTS ---{/${door_theme_1.T.ok}-fg}{/bold}

{${door_theme_1.T.accent}-fg}Navigation:{/${door_theme_1.T.accent}-fg}
  Tab           Next channel
...
{${door_theme_1.T.accent}-fg}Chat:{/${door_theme_1.T.accent}-fg}
  Enter         Send message
...
{${door_theme_1.T.accent}-fg}Window Controls:{/${door_theme_1.T.accent}-fg}
...
{${door_theme_1.T.accent}-fg}Text Formatting:{/${door_theme_1.T.accent}-fg}
...
{${door_theme_1.T.accent}-fg}Voice Channels:{/${door_theme_1.T.accent}-fg}
...
{bold}{${door_theme_1.T.ok}-fg}--- COMMANDS ---{/${door_theme_1.T.ok}-fg}{/bold}

{${door_theme_1.T.accent}-fg}Room Commands:{/${door_theme_1.T.accent}-fg}
...
{${door_theme_1.T.accent}-fg}User Commands:{/${door_theme_1.T.accent}-fg}
...
{${door_theme_1.T.accent}-fg}Status Commands:{/${door_theme_1.T.accent}-fg}
  /away [msg]       Set away status
  /back             Return from away
  /status <status>  Set status (online/away/busy/dnd)

{${door_theme_1.T.accent}-fg}Other Commands:{/${door_theme_1.T.accent}-fg}
