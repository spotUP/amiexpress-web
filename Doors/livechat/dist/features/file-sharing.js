...
function createFileSharing(s, sock, st, un, asm, acm, aa, aud, sm, hm) {
    const o = blessed_1.default.box({ parent: s, top: 'center', left: 'center', width: '70%', height: '70%', label: ' Share Files [Drag to Move | Resize: Corner | ESC: Close] ', border: { type: 'line' }, shadow: true, hidden: true, mouse: true, draggable: true, ch: ' ', style: { fg: 'white', bg: 'black', border: { fg: 'green' } } });
    o.enableResize();
