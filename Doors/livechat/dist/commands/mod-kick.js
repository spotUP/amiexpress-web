...
exports.unmuteCmd = exports.muteCmd = exports.kickCmd = void 0;
...
exports.kickCmd = {
    ...
    handler: (ctx, args) => {
        ...
        if (!target)
            return { handled: true, error: 'Usage: /kick @user [reason]' };
...
exports.muteCmd = {
    ...
    handler: (ctx, args) => {
        ...
        if (!target)
            return { handled: true, error: 'Usage: /mute @user [minutes]' };
...
exports.unmuteCmd = {
    ...
    handler: (ctx, args) => {
        const target = args[0]?.replace('@', '');
        if (!target)
            return { handled: true, error: 'Usage: /unmute @user' };
