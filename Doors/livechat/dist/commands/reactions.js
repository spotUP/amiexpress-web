...
exports.heartCmd = exports.thumbsUpCmd = exports.reactionsCmd = exports.unreactCmd = exports.reactCmd = void 0;
...
exports.reactCmd = {
    ...
    handler: (ctx, args) => {
        ...
        const msgId = args[1];
        if (!types_1.REACTION_EMOJIS.includes(emoji)) {
            const valid = types_1.REACTION_EMOJIS.join(', ');
