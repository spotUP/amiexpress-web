...
export declare function showSellOverlay(screen: any, state: PlayerState, onSell: (drugIndex: number, amount: number) => void, onCancel: () => void): void;
export declare function showJetOverlay(screen: any, currentLocation: number, onJet: (location: number) => void, onCancel: () => void): void;
