...
import {
  attachDoorChrome, type DoorChrome,
} from '@amiexpress/bbs-door-sdk/engines/ui/theme';
import { T, S, THEME, applyTheme } from './door-theme';
 ...
 */
export const REQUESTER_COLS = 44;
  ...
  private pick(title: string, items: string[]): Promise<number | null> {
    return new Promise((resolve) => {
      ...
      const chrome = attachDoorChrome(THEME, {
        ...
        title,
        masthead: { setContent: (text: string) => list.setLabel(text) },
        ...
        // screen's.
        mastheadWidth: Math.max(1, REQUESTER_COLS - 5),
        glitch: list,
