...
export const ANIMAL_STATS: Record<AnimalType, {
  ...
  strength: number;  // Wall damage per hit (1-3)
  char: string;
  color: string;
}> = {
...
export const JUMP_SCORES: Record<number, number> = {
  1: 100,
  2: 500,
  3: 2000,
  4: 6000,
...
// Bonus items
export const BONUS_ITEMS: Record<BonusItemType, {
  points: number;
  char: string;
  color: string;
  isNet: boolean;
...
export const WALL_CHARS: Record<number, string> = {
  0: ' ',   // Broken/gap
  1: '.',   // Weak
  2: '+',   // Medium
  3: '#'    // Strong
