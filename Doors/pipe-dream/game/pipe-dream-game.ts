...
export class PipeDreamGame {
  ...
  private getRandomPipe(): PipeType {
  ...
  private getNextCell(x: number, y: number, direction: Direction): { x: number; y: number; entryDirection: Direction } | null {
  ...
  private getPipeConnections(pipeType: PipeType, cell: Cell): Record<Direction, boolean> {
  ...
  private getExitDirection(pipeType: PipeType, entryDirection: Direction, cell: Cell): Direction | null {
