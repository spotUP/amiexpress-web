...
// Sound effects.
//
// Pipe Dream's game logic runs server-side, so it names what happened and the
...
const audio = new AudioEngine({
  masterVolume: 0.7,
  sfxVolume: 0.55,
  // A plant room. Each pipe the water fills ticks, and a tick that rings
  // on covers the next one.
  //
