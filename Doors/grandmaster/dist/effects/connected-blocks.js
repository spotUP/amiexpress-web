...
exports.ConnectedBlockRenderer = void 0;
/**
...
(function (Direction) {
    ...
    Direction[Direction["S"] = 16] = "S";
    Direction[Direction["SW"] = 32] = "SW";
    Direction[Direction["W"] = 64] = "W";
    Direction[Direction["NW"] = 128] = "NW"; // North-West
})(Direction || (Direction = {}));
/**
    ...
    calculateAdjacency(board) {
        ...
        for (let y = 0; y < board.height; y++) {
            for (let x = 0; x < board.width; x++) {
                ...
                if (this.isSameColor(board, x, y - 1, color))
                    adjacency |= Direction.N;
                if (this.isSameColor(board, x + 1, y - 1, color))
                    adjacency |= Direction.NE;
                if (this.isSameColor(board, x + 1, y, color))
                    adjacency |= Direction.E;
                if (this.isSameColor(board, x + 1, y + 1, color))
                    adjacency |= Direction.SE;
                if (this.isSameColor(board, x, y + 1, color))
                    adjacency |= Direction.S;
                if (this.isSameColor(board, x - 1, y + 1, color))
                    adjacency |= Direction.SW;
                if (this.isSameColor(board, x - 1, y, color))
                    adjacency |= Direction.W;
                if (this.isSameColor(board, x - 1, y - 1, color))
                    adjacency |= Direction.NW;
...
exports.ConnectedBlockRenderer = ConnectedBlockRenderer;
//# sourceMappingURL=connected-blocks.js.map