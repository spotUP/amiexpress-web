...
exports.LineClearAnimationManager = void 0;
/**
 ...
 */
class LineClearAnimationManager {
    constructor() {
        this.animation = null;
        this.BOARD_WIDTH = 10;
        this.enabled = true;
     ...
     */
    startClearAnimation(lines, style, direction = 'in', speedMultiplier = 1.0) {
     ...
     */
    shouldRenderCell(x, y) {
        if (!this.animation)
            return true;
        // Check if this Y position is being animated
        if (!this.animation.lines.includes(y))
            return true;
        // Check fade progress
     ...
     */
    calculateInwardFade(x, progress) {
     ...
     */
    calculateOutwardFade(x, progress) {
     ...
     */
    calculateDirectionalFade(x, progress, direction) {
        if (direction === 'in') {
            return this.calculateInwardFade(x, progress);
        }
        else {
     ...
     */
    static applyFade(baseChar, fade) {
...
exports.LineClearAnimationManager = LineClearAnimationManager;
//# sourceMappingURL=line-clear-animation.js.map