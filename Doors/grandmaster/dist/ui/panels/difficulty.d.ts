...
export declare const DIFFICULTY_ROWS: readonly ChooserRow[];
export declare const DIFFICULTY_VALUES: readonly ClassicDifficulty[];
/** Where the list opens. */
export declare const DEFAULT_DIFFICULTY: ClassicDifficulty;
export declare function defaultDifficultyIndex(): number;
