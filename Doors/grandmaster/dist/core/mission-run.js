...
exports.nextIsHidden = nextIsHidden;
/**
...
class MissionRun {
    ...
    target() {
        if (this.mission.objective === 'survive')
            return 0;
        if (this.mission.objective === 'cycle')
            return 4; // one of each clear size
...
exports.MissionRun = MissionRun;
//# sourceMappingURL=mission-run.js.map