...
export declare const MASTER_TORIKAN_FRAMES: number;
export declare const DOOM_TORIKAN_FRAMES: Record<DoomDifficultyBand, number>;
/**
 ...
 */
export declare function checkTorikan(input: TorikanCheckInput): TorikanResult;
