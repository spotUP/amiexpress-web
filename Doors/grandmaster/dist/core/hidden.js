...
exports.SHADOW_TIMER_FRAMES = void 0;
exports.shadowDecayRate = shadowDecayRate;
exports.countHiddenCells = countHiddenCells;
exports.isCellHidden = isCellHidden;
/** init.c:732 `p_shadow_timer = 300`. */
exports.SHADOW_TIMER_FRAMES = 300;
/** Frames subtracted per tick, by mode. 0 = HIDDEN is off. */
function shadowDecayRate(mode) {
    switch (mode) {
 ...
 */
function countHiddenCells(board) {
    let hidden = 0;
