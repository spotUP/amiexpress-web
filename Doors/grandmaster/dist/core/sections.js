...
class SectionManager {
    constructor() {
        this.sections = [];
        this.borderRank = 0; // border_rank in HeborisCE
     ...
     */
    update(currentLevel, linesCleared) {
