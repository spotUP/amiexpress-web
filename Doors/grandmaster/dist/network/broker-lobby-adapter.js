...
exports.BrokerLobbyAdapter = void 0;
const blessed_1 = require("@amiexpress/bbs-door-sdk/engines/ui/blessed");
const bot_lobby_1 = require("./bot-lobby");
/**
 * Adapter that wraps GrandmasterNetworkManager for the SDK MultiplayerLobby
 */
class BrokerLobbyAdapter extends blessed_1.EventEmitter {
    ...
    async joinQueue(mode) {
        ...
        await this.network.joinQueue(mode, this.lobbySize());
    ...
    async createLobby(mode, isPrivate) {
        ...
        const lobbyId = await this.network.createLobby(mode, isPrivate, this.lobbySize());
...
exports.BrokerLobbyAdapter = BrokerLobbyAdapter;
//# sourceMappingURL=broker-lobby-adapter.js.map