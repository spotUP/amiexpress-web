...
export const UP_KEY_LOCK_SYSTEMS: readonly RotationSystem[] = [
...
export function lockedByUpKey(rotationSystem: RotationSystem): boolean {
  return UP_KEY_LOCK_SYSTEMS.includes(rotationSystem);
}
