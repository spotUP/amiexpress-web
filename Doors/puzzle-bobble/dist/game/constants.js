...
// Colors available
export const ALL_COLORS = ['red', 'blue', 'green', 'yellow', 'purple', 'orange'];
// Color display characters
export const BUBBLE_CHARS = {
    red: 'R',
    blue: 'B',
    green: 'G',
    yellow: 'Y',
...
export const BUBBLE_TERM_COLORS = {
    red: 'red',
    blue: 'blue',
    green: 'green',
    yellow: 'yellow',
...
export function generateLevelPattern(level) {
    const config = getLevelConfig(level);
