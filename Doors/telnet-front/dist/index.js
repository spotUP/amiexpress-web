 ...
 */
function getNodes(bbs, currentNodeNumber, currentUserIp) {
    ...
    const activeUsers = typeof bbs?.getOnlineUsers === 'function' ? bbs.getOnlineUsers() : [];
    const nodes = [];
 ...
 */
async function displayFrontend(socket, user, bbs) {
