...
// FILE LOADING
// =============================================================================
export async function loadFile(state, filename) {
...
// ANSI FORMAT (.ANS)
// =============================================================================
function loadANSI(state, content, filename) {
...
// =============================================================================
function loadASCII(state, content, filename) {
...
// BINARY FORMAT (.BIN)
// =============================================================================
function loadBinary(state, filepath, filename) {
...
// XBIN FORMAT (.XB)
// =============================================================================
function loadXBin(state, filepath, filename) {
    const buffer = fs.readFileSync(filepath);
...
// FILE SAVING
// =============================================================================
export async function saveFile(state, filename) {
    const filepath = path.join(SCREENS_DIR, filename);
    const format = detectFormat(filename);
...
function saveANSI(state, filepath, filename) {
    let output = '';
    let lastFg = -1;
    let lastBg = -1;
...
function saveASCII(state, filepath, filename) {
    let output = '';
    for (let y = 0; y < state.height; y++) {
        for (let x = 0; x < state.width; x++) {
...
function saveBinary(state, filepath, filename) {
...
function saveXBin(state, filepath, filename) {
...
// IMPORT/EXPORT
// =============================================================================
export async function importFile(state, filename, x, y) {
...
export async function exportSelection(state, filename, x1, y1, x2, y2) {
 ...
 */
export function deepCloneCanvas(canvas) {
    const cloned = [];
 ...
 */
export async function exportToDiz(state, filename) {
    try {
        const filepath = path.join(SCREENS_DIR, filename);
