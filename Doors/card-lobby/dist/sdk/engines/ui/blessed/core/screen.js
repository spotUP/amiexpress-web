    ...
    _renderShadow(pos) {
        ...
        for (; y < yl + 1; y++) {
            ...
            for (; x < xl + 2; x++) {
                ...
                this.buffer[y][x][0] = (0, colors_1.blend)(this.buffer[y][x][0]);
            }
        }
        ...
        if (isBlendTransparent) {
            ...
            for (let y = startY; y < maxY; y++) {
                ...
                for (let x = startX; x < bbsMaxX; x++) {
                    ...
                    const blendedAttr = (0, colors_1.blend)(baseAttr, existingAttr);
            ...
            while (idx < line.length && x < bbsMaxX) {
                ...
                if (x >= 0 && x < this.width) {
                    if (isBlendTransparent) {
                        ...
                        const existingAttr = this.buffer[y][x][0];
                        // Two arguments = transparency mode (blends at 50% alpha by default)
                        const blendedAttr = (0, colors_1.blend)(currentAttr, existingAttr);
