...
export const WIDE_DESKTOP_COLUMNS = 120;
export const WIDE_DESKTOP_ROWS = 30;

export function hasRoomForEverything(width: number, height: number): boolean {
  return width >= WIDE_DESKTOP_COLUMNS && height >= WIDE_DESKTOP_ROWS;
}
